...
| Token-saving clarity | Add local byte counts, approximate token estimates, cache hit/miss visibility, stale state, and local reduction benchmarks without provider billing claims. |
