...
| Agent handoff | Bounded handoff packets now ship with active task, context, memory notes, validation commands, blockers, and omission reasons. Future work can add stronger decision-memory prioritization. |
