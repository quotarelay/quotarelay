...
applyTo: "{README.md,docs/EXECUTION_TRACKER.md,docs/**/*.md,openapi/**/*.yaml,.github/copilot-instructions.md,.github/instructions/*.instructions.md}"
---

# Planning And Truth Guardrails

- `docs/EXECUTION_TRACKER.md` is the active local execution surface until a canonical external tracker is adopted.
...
- If scope changes, update `docs/EXECUTION_TRACKER.md` first before widening implementation.
